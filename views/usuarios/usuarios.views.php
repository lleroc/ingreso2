            ...
            <form id="form_usuarios" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="Cedula" id="Cedula" class="form-control" onfocusout="unoconCedula()" placeholder="Ingrese su Cedula" required>
                    ...
                    <div class="form-group">
                        ...
                        <select id="SucursalId" name="SucursalId" class="form-control" required>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="Nombres">Fotografía</label>
                        <input type="file" id="imagenUsuario" name="imagenUsuario" class="form-control">
                    </div>
                </div>
